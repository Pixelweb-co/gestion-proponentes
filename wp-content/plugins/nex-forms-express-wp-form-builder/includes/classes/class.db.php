    ...
    <div class="col-xs-5">
      ...
      <div class="set_rule_actions">
        <div class="the_rule_actions">
          <div class="input-group"><span class="input-group-addon">THEN</span>
					...
					if($action_field_type)
						...
						$output .= '<div class="the_rule_actions">';
								...
								$output .= '<div class="input-group">';
									...
									$output .= '</select>';
									$output .= '<span class="input-group-addon"><span class="fa fa-caret-right"></span></span><select name="cla_field" class="cla_field form-control" style="" data-selected="'.$action_field2[0].'">';
